        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="flex items-center justify-center w-10 h-10 bg-primary/10 rounded-full text-primary hover:bg-primary hover:text-primary-foreground transition-all duration-300"
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#stylists" className="text-muted-foreground hover:text-primary transition-colors">
                  Our Stylists
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-muted-foreground">hello@yoursalon.rw</span>
              </div>
            </div>
          </div>
        </div>
